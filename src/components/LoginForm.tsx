    ...
    <section className="login__container">
      <form className='form__login'>
        <div className="inputsLog mb-3">
          <label htmlFor="exampleInputEmail1" className="form-label login__info__text">Username</label>
          <input type="Name" className="form-control inputPl" id="exampleInputEmail1" aria-describedby="emailHelp"/>
        </div>
        <div className="inputsLog mb-3">
          <label htmlFor="exampleInputPassword1" className="form-label login__info__text">Password</label>
